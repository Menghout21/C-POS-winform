    ...
    internal class clsInvoice
    {
        ...
        public int order()
        {
            try
            {
                ...
                //using (SqlCommand cmd = new SqlCommand("INSERT INTO Invoice (UserId,CustomerId,TotalAmount,TotalQty,TotalPaid,DueAmount,Status,IsReturn) OUTPUT INSERTED.ID VALUES (@UserId,@CustomerId,@TotalAmount,@TotalQty,@TotalPaid,@DueAmount,@Status,@IsReturn)", clsHelper.con))
                //{
                //    //cmd.Parameters.AddWithValue("@UserId", UserId);
                //    //cmd.Parameters.AddWithValue("@CustomerId", CustomerId);
                //    //cmd.Parameters.AddWithValue("@TotalAmount", TotalAmount);
                ...
                //    cmd.Parameters.AddWithValue("@TotalAmount", 10);
                //    cmd.Parameters.AddWithValue("@TotalQty", 1);
                //    cmd.Parameters.AddWithValue("@TotalPaid", 10);
